...
public:
	...
	static bool IntersectLinePlane(Vector a_lineStart, Vector a_lineEnd, Vector a_planeCentre, Vector a_planeNormal, Vector& a_intesection_OUT);
	...
	static bool IntersectLineAxisBox(Vector a_lineStart, Vector a_lineEnd, Vector a_boxPos, Vector a_boxDimensions, Vector& a_intersection_OUT);
	...
	static bool IntersectLineSphere(Vector a_lineStart, Vector a_lineEnd, Vector a_spherePos, float a_sphereRadius);
	...
	static bool IntersectPointAxisBox(const Vector& a_point, const Vector& a_boxPos, const Vector& a_boxDimensions);
	...
	static bool IntersectAxisBoxes(const Vector& a_box1Pos, const Vector& a_box1Dim, const Vector& a_box2Pos, const Vector& a_box2Dim);
	...
	//\param a_sphereRadius is the size of the sphere
	//\return true if the point is on or inside the box
	static bool IntersectPointSphere(Vector a_point, Vector a_spherePos, float a_sphereRadius);
	...
	static bool IntersectSpheres(const Vector& a_bodyAPos, float a_bodyARadius, const Vector& a_bodyBPos, float bodyBRadius, Vector& a_collisionPos_OUT, Vector& a_collisionNormal_OUT);
	...
	//\a_collisionNormal_OUT Output parameter of the normalized direction of the collision if there is one
	//\return true if the two supplied spheres are touching and the a_normal_OUT was modified
	static bool IntersectBoxes(const Vector& a_boxAPos, const Vector& a_boxASize, const Quaternion& a_boxARot, const Vector& a_boxBPos, const Vector& a_boxBSize, const Quaternion& a_boxBRot, Vector& a_collisionPos_OUT, Vector& a_collisionNormal_OUT);
	...
	//\a_collisionPosition_OUT Output parameter of the worldspace position of the collision if there is one	
	//\a_collisionNormal_OUT Output parameter of the normalized direction of the collision if there is one
	//\return true if the two supplied shapes are touching and the a_normal_OUT was modified
	static bool IntersectBoxSphere(const Vector& a_spherePos, float a_sphereRadius, const Vector& a_boxPos, const Vector& a_boxSize, const Quaternion& a_boxRot, Vector& a_collisionPos_OUT, Vector& a_collisionNormal_OUT);

	//\brief Intersection between an unroted axis box and a sphere
	//\param a_spherePos The position of a sphere in worldspace
	//\param a_sphereRadius The size of the sphere from centre to extent
	//\param a_boxPos The position of a box in worldspace
	//\param a_boxSize The size of the box in all three axis
	...
	//\a_collisionNormal_OUT Output parameter of the normalized direction of the collision if there is one
	//\return true if the two supplied shapes are touching and the a_normal_OUT was modified
	static bool IntersectAxisBoxSphere(const Vector& a_spherePos, float a_sphereRadius, const Vector& a_boxPos, const Vector& a_boxSize, Vector& a_collisionPos_OUT, Vector& a_collisionNormal_OUT);
};
