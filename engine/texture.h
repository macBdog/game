...
public:
    ...
    bool LoadTGAFromFile(const std::string & a_tgaFilePath, bool a_useLinearFilter = true);
    ...
    inline const std::string_view GetFileName() { return StringUtils::ExtractFileNameFromPath(m_filePath); }
...
private:
    ...
    std::string m_filePath; ///< File path stored off during load, fully qualified
