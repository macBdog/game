...
bool eRenderManager::Init(cColour a_clearColour)
{
...
bool eRenderManager::Resize(unsigned int a_viewWidth, unsigned int a_viewHeight, unsigned int a_viewBpp, bool a_fullScreen)
{
